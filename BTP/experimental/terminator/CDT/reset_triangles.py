...
from CDT.hash_table import get_seg_idx
...
def reset_tri_2(
        ...
        seg_ht_cap, seg_ht_arr, tri_to_be_deleted):
    '''
    insertion_points : k x 2 array (virus introduced at these k points)
    '''
    # print(insertion_points)
    ...
    for k in range(num_viral_points):
        ...
        while tri_iter < num_tri_to_be_deleted:
            ...
            tri_idx = tri_to_be_deleted[tri_iter]
            tri_iter += 1
            # print("num_tri_to_be_deleted : {}, tri_iter : {}, tri_idx : {}".format(num_tri_to_be_deleted, tri_iter, tri_idx))
