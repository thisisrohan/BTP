...
def orient3dadapt(pa, pb, pc, pd, permanent, bc, ca, ab, adet, bdet, cdet,
    ...
    adx, adxtail = Two_Diff_Tail(pa[0], pd[0])
    bdx, bdxtail = Two_Diff_Tail(pb[0], pd[0])
    cdx, cdxtail = Two_Diff_Tail(pc[0], pd[0])
    ady, adytail = Two_Diff_Tail(pa[1], pd[1])
    bdy, bdytail = Two_Diff_Tail(pb[1], pd[1])
    cdy, cdytail = Two_Diff_Tail(pc[1], pd[1])
    adz, adztail = Two_Diff_Tail(pa[2], pd[2])
    bdz, bdztail = Two_Diff_Tail(pb[2], pd[2])
    cdz, cdztail = Two_Diff_Tail(pc[2], pd[2])
